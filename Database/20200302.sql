...
CREATE TABLE `location_tab` (
  ...
  `location_tab_name` varchar(255) DEFAULT NULL,
  `is_active` int DEFAULT '1',
...
CREATE TABLE `payment_type` (
  `paymen_type_id` int NOT NULL AUTO_INCREMENT,
  `paymen_type_name` varchar(45) NOT NULL,
  PRIMARY KEY (`paymen_type_id`)
...
CREATE TABLE `printer` (
  ...
  `printername` varchar(45) NOT NULL,
...
-- Dump completed on 2021-03-02 21:46:30
